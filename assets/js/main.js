...
function initAppleWatchHeroMosaic() {
  ...
  if (!document.getElementById('mosaic-idle-keyframes')) {
    ...
    style.innerHTML = `@keyframes idleFloat { 0% { transform: translate(calc(var(--tile-x) + var(--hover-x)), calc(var(--tile-y) + var(--hover-y) - 3px)); } 100% { transform: translate(calc(var(--tile-x) + var(--hover-x)), calc(var(--tile-y) + var(--hover-y) + 3px)); } }`;
